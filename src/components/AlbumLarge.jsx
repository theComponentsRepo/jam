  ...
  return (
    <div>
      ...
      <div className="album-large-container p-4 flex bg-cyan-600 text-neutral-100 xs:flex-col xs:items-center xs:gap-2">
        ...
        <div className="album-large-img pr-4 drop-shadow-xl xs:w-64 sm:w-56 md:w-72 lg:w-72">
        ...
        <div className="album-large-content text-left	flex flex-col justify-between">
          <div className="album-title">
            ...
            <h1 className=" font-extrabold	drop-shadow-xl  xs:text-md xs:leading-tight sm:text-2xl md:text-4xl lg:text-5xl">{data.title}</h1>
          </div>
