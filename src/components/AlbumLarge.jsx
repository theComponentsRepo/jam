      ...
      <div className="album-large-container p-4 flex bg-cyan-600 text-neutral-100 xs:flex-col xs:items-center xs:gap-2">
        ...
        <div className="album-large-content text-left	flex flex-col justify-between">
          <div className="album-title">
            ...
            <h1 className=" font-extrabold	drop-shadow-xl  xs:text-md xs:leading-tight sm:text-2xl sm:leading-none md:text-5xl lg:text-6xl">{data.title}</h1>
          </div>
          <ul className="font-light list-disc flex xs:text-xs xs:leading-tight sm:leading-none sm:flex-col sm:list-none sm:gap-0 sm:text-xs gap-5">
