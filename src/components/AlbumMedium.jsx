...
export default function AlbumMedium(props) {
  ...
  return (
    <div className="album-cover-container flex flex-col p-4 bg-slate-100 xs:w-32 sm:w-48 md:w-48 lg: w-48 justify-center shadow-lg rounded-lg hover:bg-slate-200" onClick={handleRedirect}>
      <div className="album-cover-img mb-3 overflow-hidden flex justify-center">
        <img className="xs:w-32 sm:w-48" src={albumInfo.cover_medium} alt="" />
      </div>
